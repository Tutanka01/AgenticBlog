...
from config import LLM_MODEL, LLM_TEMPERATURE, INTEREST_TOPICS, PROMPTS_DIR, OUTPUT_LANGUAGE_LABELS
...
def _build_blog_post(draft: str, run_date: str, tags: list[str],
    ...
    """Prepend YAML front matter to the validated draft. Does not rewrite the content."""
    front_matter = {
        "title": title,
        "date": run_date,
        "tags": tags,
...
def formatter_node(state: PipelineState) -> dict:
    ...
    - blog_post: YAML front matter + validated draft (NO LLM rewrite)
